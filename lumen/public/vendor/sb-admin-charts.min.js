...
var ctx = document.getElementById("myAreaChart"),
    myLineChart = new Chart(ctx, {
        type: "line",
        data: {
            labels: ["1-9", "10-15", "16-20", "21-24", "25-29", "30-35", "36-40", "41-45", "46-50", "51-55", "56-60", "61-65", "66-70", "71+"],
            datasets: [{
                label: "คนรักรถ",
                lineTension: .3,
                ...
                pointBorderWidth: 2,
                data: 
                    [1e4, 30162, 18394, 26263, 31984, 28682, 25849, 33259, 25849, 24159, 32651, 32651, 26263]
            },
            {
                label: "Sessions",
                lineTension: .3,
                backgroundColor: "rgba(2,117,216,0.2)",
                borderColor: "rgba(250, 111, 97,1)",
                pointRadius: 5,
                pointBackgroundColor: "rgba(250, 111, 97)",
                pointBorderColor: "rgba(255,255,255,0.8)",
                pointHoverRadius: 5,
                pointHoverBackgroundColor: "rgba(2,117,216,1)",
                pointHitRadius: 20,
                pointBorderWidth: 2,
                data: 
                    [1e4, 30162, 26263, 18394, 18287, 28682, 31274, 33259, 25849, 24159, 32651, 31984, 38451],
            },
            {
                label: "Sessions",
                lineTension: .3,
                backgroundColor: "rgba(200,34,216,0.2)",
                borderColor: "rgba(250, 111, 97,1)",
                pointRadius: 5,
                pointBackgroundColor: "rgba(250, 111, 97)",
                pointBorderColor: "rgba(255,255,255,0.8)",
                pointHoverRadius: 5,
                pointHoverBackgroundColor: "rgba(200,34,216,1)",
                pointHitRadius: 20,
                pointBorderWidth: 2,
                data: 
                    [1e4, 26263, 18287, 26263, 18287,8682, 31274, 26263, 26263, 24159, 32651, 31984, 26263],
            }
        ]
    },
        options: {
